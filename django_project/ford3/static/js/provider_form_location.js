...
$(document).ready(function () {
    let location_x = document.querySelector('#id_location_value_x').value
    let location_y = document.querySelector('#id_location_value_y').value
    setupMap(location_x, location_y)
})

const setAddress = (evt) => {
    let input_line_1 = document.querySelector('#id_physical_address_line_1')
    let input_line_2 = document.querySelector('#id_physical_address_line_2')
    let input_city = document.querySelector('#id_physical_address_city')
    let input_code = document.querySelector('#id_physical_address_postal_code')
