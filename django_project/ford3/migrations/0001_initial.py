# Generated by Django 2.1.7 on 2019-05-31 12:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone', models.CharField(help_text="The campus' telephone number", max_length=16, null=True, validators=[django.core.validators.RegexValidator(message='Phone number must be at least 10 digits and at max 15 digits.It can start with +(country code)', regex='^\\+?1?\\d{10,15}$')])),
                ...
                ('deleted_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='campus_deleted_by', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='campus_events', to='ford3.Campus')),
            ],
        ),
        migrations.CreateModel(
            name='FieldOfStudy',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone', models.CharField(blank=True, help_text='Prospect telephone number', max_length=16, validators=[django.core.validators.RegexValidator(message='Phone number must be at least 10 digits and at max 15 digits.It can start with +(country code)', regex='^\\+?1?\\d{10,15}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone', models.CharField(help_text="The provider's telephone number", max_length=16, null=True, validators=[django.core.validators.RegexValidator(message='Phone number must be at least 10 digits and at max 15 digits.It can start with +(country code)', regex='^\\+?1?\\d{10,15}$')])),
                ...
                ('admissions_contact_no', models.CharField(help_text='A contact number students interested in applying can use', max_length=16, null=True, validators=[django.core.validators.RegexValidator(message='Phone number must be at least 10 digits and at max 15 digits.It can start with +(country code)', regex='^\\+?1?\\d{10,15}$')])),
                ...
                ('deleted_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='provider_deleted_by', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='qualification_set', to='ford3.Campus')),
                ...
                ('deleted_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='qualification_deleted_by', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qualification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='qualification_events', to='ford3.Qualification')),
            ],
        ),
        migrations.CreateModel(
            name='Requirement',
            fields=[
                ...
                ('qualification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requirement_set', to='ford3.Qualification')),
            ],
        ),
        migrations.CreateModel(
